...
Поле **“code”** содержит код ошибки вида SOME_ERROR_DETAIL. Рекомендуем посмотреть какие коды ошибок уже используются, чтобы **не дублировать** уже существующие коды с новым именем.
