# REST API Best Practices <a name="REST_API_Best_Practices"></a>
+ [REST API Best Practices](#REST_API_Best_Practices)
  + [Общие рекомендации](#Общие_рекомендации)
  + [Формат даты-времени](#Формат_даты-времени)
  + [Формат стран, валют и сумм](#Формат_стран_валют)
  + [Детализация ошибки в теле ответа](#Детализация_ошибки_тело_ответа)
  + [Формат URL](#Формат_URL)
  + [Версионирование](#Версионирование)
    + [Обработка ошибок версионирования](#Обработка_ошибок_версионирования)
  + [Обратно-совместимые и ломающие изменения](#Обратно-совместимые_ломающие_изменения)
...
## Общие рекомендации <a name="Общие_рекомендации"></a>

Это первая версия гайда по лучшим практикам REST API

## Формат даты-времени <a name="Формат_даты-времени"></a>
...
## Детализация ошибки в теле ответа <a name="Детализация_ошибки_тело_ответа"></a>
...
## Формат URL <a name="Формат_URL"></a>
...
## Версионирование  <a name="Версионирование"></a> 
...
### Обработка ошибок версионирования <a name="Обработка_ошибок_версионирования"></a>
...
## Обратно-совместимые и ломающие изменения <a name="Обратно-совместимые_ломающие_изменения"></a> 
