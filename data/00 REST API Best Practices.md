...
Рекомендуется выполнять аутентификацию всех запросов (нужно ли исключение для информационных запросов?) с помощью Bearer токенов, если аутентификация не пройдена то следует ответить кодом 401 со стандартным телом ошибки. Если аутентификация пройдена, но дейстие не авторизовано, следует использовать код 403.
