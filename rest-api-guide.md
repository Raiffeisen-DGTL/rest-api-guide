...
## Именование методов
### Формат URL для эндпоинтов которые возвращают true/false (Outdated)
...
### Обратные вызовы к клиентам (Outdated)
...
### Обработка ошибок версионирования (Outdated)
...
## Обратно-совместимые и ломающие изменения (Outdated:Добавление полей в ответ рекомендуем избегать, чтобы не сломать логику на стороне клиента)
...
## Пагинация (Outdated:Уточнить для небольших объемов данных)
