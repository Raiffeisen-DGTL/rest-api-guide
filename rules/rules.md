...
- [Правила](#правила)
    ...
    - [Стандартная структура ответа с ошибкой API](#стандартная-структура-ответа-с-ошибкой-api)
...
| ID                         | Severity | Дата принятия |
|----------------------------|----------|---------------|
| response-error-structure   | MUST     | 11.02.2026    |
...
- `error.details` - массив ошибок (обязательно при ошибках валидации, иначе `null` или отсутствует)
- `error.details[n].param` - путь к полю с ошибкой валидации
- `error.details[n].message` - описание ошибки валидации
- `error.details[n].code` - необзяательно поле уточняющее тип ошибки
