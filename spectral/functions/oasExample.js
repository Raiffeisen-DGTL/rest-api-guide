...
const MEDIA_VALIDATION_ITEMS = {
    2: [
        {field: "examples", multiple: true, keyed: false},
    ],
    3: [
...
function cleanSchema(schema) {
    traverse(schema, {allKeys: true}, (fragment, jsonPtr, rootSchema, parentJsonPtr, parentKeyword) => {
...
function relaxRequired(schema, readOnlyProperties, writeOnlyProperties) {
    if (readOnlyProperties || writeOnlyProperties)
        traverse(schema, {}, (fragment, jsonPtr, rootSchema, parentJsonPtr, parentKeyword, parent, propertyName) => {
